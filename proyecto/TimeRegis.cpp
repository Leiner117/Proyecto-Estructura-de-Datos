...
TimeRegis* TimeRegis::dataLoad(TimeRegis* timeList){
    ...
    timeList=add(1657432800,4567,25.3,12.5,23,0,32,true,timeList); // 10 / 07 / 2022
    //timeList=add(1577836800,5345,25.0,11.4,29,73,26,true,timeList); [ 18 : 00 : 00 ] 31 / 12 / 2019
    //timeList=add(1578009600,887,27.0,12.9,28,25,36,false,timeList); //  [ 18 : 00 : 00 ] 02 / 01 / 2020
    //timeList=add(1581292800,235,23.3,16.5,25,60,32,true,timeList);//  [ 18 : 00 : 00 ] 09 / 02 / 2020
    //timeList=add(1580688000,5571,15.9,5.6,31,69,29,true,timeList); //[ 18 : 00 : 00 ] 02 / 02 / 2020
    //timeList=add(1583366400,5486,12.4,6.9,6,83,21,true,timeList); //  [ 18 : 00 : 00 ] 04 / 03 / 2020
    //timeList=add(1586217600,4911,8.8,3.8,34,70,20,true,timeList); //  [ 18 : 00 : 00 ] 06 / 04 / 2020
    //timeList=add(1588982400,2688,17.3,11.0,27,93,19,true,timeList); // [ 18 : 00 : 00 ] 08 / 05 / 2020
    //timeList=add(1591833600,9875,31.5,15.3,19,60,34,true,timeList); // [ 18 : 00 : 00 ] 10 / 06 / 2020
    //timeList=add(1594598400,1135,20.1,14.1,13,80,2,true,timeList); // [ 18 : 00 : 00 ] 12 / 07 / 2020
    //timeList=add(1597449600,887,27.0,12.9,28,25,36,true,timeList); //[ 18 : 00 : 00 ] 14 / 08 / 2020
    //timeList=add(1603065600,235,23.3,16.5,25,60,32,true,timeList); //[ 18 : 00 : 00 ] 18 / 10 / 2020
    //timeList=add(1605916800,887,27.0,12.9,28,25,36,true,timeList); //[ 18 : 00 : 00 ] 20 / 11 / 2020
    //timeList=add(1608681600,235,23.3,16.5,25,60,32,true,timeList); //[ 18 : 00 : 00 ] 22 / 12 / 2020
    //timeList=add(1584403200 ,887,27.0,12.9,28,25,36,false,timeList);//[ 18 : 00 : 00 ] 16 / 03 / 2020
    //timeList=add(1587686400 ,235,23.3,16.5,25,60,32,true,timeList);// [ 18 : 00 : 00 ] 23 / 04 / 2020
    ...
    timeList=add(1580623200 ,568,23.3,16.5,25,60,32,true,timeList); //09 / 02 / 2020
    ...
    timeList=add(1587621600 ,987,23.3,16.5,25,60,32,true,timeList); //23 / 04 / 2020
    ...
    timeList=add(1591768800 ,298,23.3,16.5,25,60,32,true,timeList);//10 / 06 / 2020
    timeList=add(1594533600 ,345,23.3,16.5,25,60,32,true,timeList);// 12 / 07 / 2020

    timeList=add(1596520800 ,369,23.3,16.5,25,60,32,true,timeList);// 4 / 08 / 2020
    timeList=add(1597557600 ,215,23.3,16.5,25,60,32,true,timeList);// 16 / 08 / 2020
    timeList=add(1598335200 ,896,23.3,16.5,25,60,32,true,timeList);// 25 / 08 / 2020
    timeList=add(1600236000 ,612,23.3,16.5,25,60,32,true,timeList);//16 / 09 / 2020
